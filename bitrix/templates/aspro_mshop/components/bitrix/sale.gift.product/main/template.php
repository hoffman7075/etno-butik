...
if (!empty($arResult['ITEMS'])){
	...
	if (!empty($arResult['SKU_PROPS'])){
		$arSkuTemplate=CMShop::GetSKUPropsArray($arResult['SKU_PROPS'], $arResult["SKU_IBLOCK_ID"], "block", $arParams["OFFER_HIDE_NAME_PROPS"], "Y");
	}?>
	<script type="text/javascript">
		BX.message({
	...
	<div class="bx_item_list_you_looked_horizontal gift_block <? echo $templateData['TEMPLATE_CLASS']; ?>">
										...
										<?if(!empty($arItem['OFFERS']) /*&& isset($arSkuTemplate[$arItem['IBLOCK_ID']])*/){?>
											<?if(!empty($arItem['OFFERS_PROP'])){?>
												<div class="sku_props">
													...
													<?$arItemJSParams=CMShop::GetSKUJSParams($arResult, $arParams, $arItem, "N", "Y");?>
