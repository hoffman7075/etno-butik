<?
	...
	$arTemplateParametersParts[] = array(	
		...
		"VIEWED_ELEMENT_COUNT" => array(
			'PARENT' => 'VISUAL',
			'NAME' => GetMessage('VIEWED_ELEMENT_COUNT'),
			'TYPE' => 'STRING',
			'DEFAULT' => '20',
		),
		"VIEWED_BLOCK_TITLE" => array(
			'PARENT' => 'VISUAL',
			'NAME' => GetMessage('VIEWED_BLOCK_TITLE'),
			'TYPE' => 'STRING',
			'DEFAULT' => GetMessage('VIEWED_TITLE'),
		),
	);
