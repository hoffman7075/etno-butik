...
<?endif;?>
	...
	<div class="opener" title="<?=$arResult['allSum_FORMATED']?>">
		...
		<div class="wish_count<?=($delayCount?"":" empty")?> small" data-type="DelDelCanBuy">
			<a href="<?=$arParams["PATH_TO_BASKET"];?>#tab_DelDelCanBuy"></a>
	...
	?>
		<div class="basket_sort">
			...
			<span class="wrap_remove_button">
				<?if($normalCount){?>
					<span class="button grey_br transparent remove_all_basket AnDelCanBuy cur" data-type="1"><?=GetMessage('CLEAR_BASKET')?></span>
				<?}?>
				<?if($delayCount){?>
					<span class="button grey_br transparent remove_all_basket DelDelCanBuy" data-type="2"><?=GetMessage('CLEAR_BASKET')?></span>
				<?}?>
			</span>
		</div>
