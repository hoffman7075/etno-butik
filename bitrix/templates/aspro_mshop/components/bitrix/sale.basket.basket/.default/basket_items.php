								...
								<td class="item">
									...
									<? if($arItem["PRODUCT_ID"] != 910 && $arItem["MAX_ETCH_COUNT"] > 0): ?>
										<div>
											...
											<input type="number" style="width:20%;height:26px;" onchange="etch_prov(this, 'QUANTITY_INPUT_<?=$arItem["ID"]?>', <?=($arItem["QUANTITY"]-$arItem["MAX_ETCH_COUNT"])?>);" value="1" min="1"> <br>
											<a href="javascript://" onClick="etch_save(<?=$arItem["PRODUCT_ID"]?>, this.parentNode.children[2].value, this.parentNode.children[1].value);">ОК</a>
										</div>
									<? endif; ?>
