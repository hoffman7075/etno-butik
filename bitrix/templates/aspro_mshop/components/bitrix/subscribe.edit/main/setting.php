...
<tfoot><tr><td colspan="2">
	<?if(COption::GetOptionString("aspro.mshop", "SHOW_LICENCE", "N") == "Y" && !$arResult["ID"] ):?>
		<div class="subscribe_licenses">
			<div class="licence_block filter label_block">
				...
				<?endif;?>
				<input type="checkbox" id="licenses_subscribe" <?=($_POST["licenses_subscribe"] ? "checked" : "");?> name="licenses_subscribe" value="Y">
