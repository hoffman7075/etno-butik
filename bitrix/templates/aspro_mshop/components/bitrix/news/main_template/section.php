...
<?if($arParams["USE_FILTER"]=="Y"){
	...
	{
		$iYear = (int)$arResult["VARIABLES"]["YEAR"];
		if($arYears && ($iYear && in_array($iYear, $arYears))){?>
			...
			<?$GLOBALS['arrFilter'] = array(
				">DATE_ACTIVE_FROM" => ConvertDateTime("01.01.".$iYear, "DD.MM.YYYY"),
				"<=DATE_ACTIVE_FROM" => ConvertDateTime("01.01.".($iYear+1), "DD.MM.YYYY"),
				array(
					"LOGIC" => "OR", 
		...
		{
			echo GetMessage('SECTION_NOT_FOUND');
			CHTTP::SetStatus(404);			
			return;
		}
	}?>
