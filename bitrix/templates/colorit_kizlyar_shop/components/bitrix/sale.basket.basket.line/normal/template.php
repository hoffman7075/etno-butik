...
<div class="basket_normal cart <?=(!$count || $isBasketPage || $_POST["ACTION"]=='top' ? ' empty_cart ' : '')?> <?=(!$count && $isBasketPage ? 'ecart' : '');?> <?=($isBasketPage || $_POST["ACTION"]=='top' ? 'bcart' : '');?>">
	<!--noindex-->
		<div class="wraps_icon_block delay <?=($delayCount ? '' : 'ndelay' );?>">
			<a href="<?=$arParams["PATH_TO_BASKET"];?>?ar=delayed" class="link" <?=($delayCount ? '' : 'style="display: none;"' );?> title="<?=GetMessage("BASKET_DELAY_LIST");?>"></a>
			<div class="count">
				<span>
					<span class="items">
		...
		<div class="basket_block f-left">
			...
			<div class="text f-left">
				...
				<div class="basket-custom-block">
					<div class="basket-count"><?=$arResult["NUM_PRODUCTS"]?></div>
					<div class="basket-price"><?=$summ_formated?></div>
				</div>
