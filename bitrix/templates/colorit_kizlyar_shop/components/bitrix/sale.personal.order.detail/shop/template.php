					...
					<?if($shipment["TRACKING_NUMBER"]):?>
						<tr>
							...
							<td>
								...
								<?if($arResult["DELIVERY"]["ID"] == 8):?>
									<a href="https://www.pochta.ru/tracking#<?=$shipment["TRACKING_NUMBER"];?>" target="blank">Отследить заказ</a>
								<?elseif(($arResult["DELIVERY"]["ID"] == 9) || ($arResult["DELIVERY"]["ID"] == 6) || ($arResult["DELIVERY"]["ID"] == 7)):?>
									<a href="http://www.edostavka.ru/track.html?order_id=<?=$shipment["TRACKING_NUMBER"];?>" target="blank">Отследить заказ</a>
								<?endif;?>
