...
<script type="text/javascript">
	...
	function etch_prov(obj, obj2, minus)
	{
		var max = document.getElementById(obj2).value - minus;
	...
	function etch_save(ID, count, text)
	{
...
if (strlen($arResult["ERROR_MESSAGE"]) <= 0)
{
	...
	BX.removeClass(BX("basket_toolbar_button"), "current");
		...
		if (BX("basket_items_not_available"))
			BX("basket_items_not_available").style.display = "none";</script>'
	?>
	<?
